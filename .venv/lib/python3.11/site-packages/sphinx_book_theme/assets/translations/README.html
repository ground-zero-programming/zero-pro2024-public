...
<html lang="en" >
  ...
  <head>
    ...
    <title>Translation workflow &#8212; ゼロから始めるプログラミング</title>
...
const thebe_selector_output = ".output, .cell_output"
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv/lib/python3.11/site-packages/sphinx_book_theme/assets/translations/README';</script>
...
<a class="navbar-brand logo" href="../../../../../../../intro.html">
    ...
    <img src="../../../../../../../_static/logo_dalle3.png" class="logo__image only-light" alt="Logo image"/>
    <script>document.write(`<img src="../../../../../../../_static/logo_dalle3.png" class="logo__image only-dark" alt="Logo image"/>`);</script>
...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/01/introduction_and_setup.html">第1回：イントロダクションとGoogle Colaboratoryの導入</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/02/variables_and_data_types.html">第2回：変数（講義）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/03/exercise_variables_and_data_types.html">第3回：変数（演習）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/04/conditional_branch.html">第4回：条件分岐（講義）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/05/exercise_conditional_branch.html">第5回：条件分岐（演習）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/06/loops.html">第6回：繰り返し処理（講義）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/07/exercise_loops.html">第7回：繰り返し処理（演習）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/08/functions_and_scope.html">第8回：関数（講義）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/09/exercise_functions_and_scope.html">第9回：関数（演習）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/10/class.html">第10回：クラス（講義）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/11/exercise_class.html">第11回：クラス（演習）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/12/introduction_to_data_analysis.html">第12回：データ分析入門（講義）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/13/exercise_introduction_to_data_analysis.html">第13回：データ分析入門（演習）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/14/introduction_to_machine_learning.html">第14回：機械学習入門（講義）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/15/exercise_introduction_to_machine_learning.html">第15回：機械学習入門（演習）</a></li>
</ul>
<p aria-level="2" class="caption" role="heading"><span class="caption-text">補足情報</span></p>
<ul class="nav bd-sidenav">
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/exam.html">期末試験に関する情報</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/submission/submission.html">課題提出方法</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/advanced_materials.html">さらに勉強したい人へ</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/references.html">参考文献</a></li>
</ul>
...
<div class="dropdown dropdown-source-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="https://github.com/ground-zero-programming/zero-pro2024-public" target="_blank"
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/ground-zero-programming/zero-pro2024-public/issues/new?title=Issue%20on%20page%20%2F.venv/lib/python3.11/site-packages/sphinx_book_theme/assets/translations/README.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../_sources/.venv/lib/python3.11/site-packages/sphinx_book_theme/assets/translations/README.md" target="_blank"
...
<h1>Translation workflow<a class="headerlink" href="#translation-workflow" title="Permalink to this heading">#</a></h1>
...
<h2>Structure of translation files<a class="headerlink" href="#structure-of-translation-files" title="Permalink to this heading">#</a></h2>
<section id="translation-source-files">
<h3>Translation source files<a class="headerlink" href="#translation-source-files" title="Permalink to this heading">#</a></h3>
...
<h3>Compiled translation files<a class="headerlink" href="#compiled-translation-files" title="Permalink to this heading">#</a></h3>
...
<h2>Workflow of translations<a class="headerlink" href="#workflow-of-translations" title="Permalink to this heading">#</a></h2>
...
<h2>To update a translation<a class="headerlink" href="#to-update-a-translation" title="Permalink to this heading">#</a></h2>
...
Finally, run <code class="docutils literal notranslate"><span class="pre">python</span> <span class="pre">src/sphinx_book_theme/_compile_translations.py</span></code> and this will update the <code class="docutils literal notranslate"><span class="pre">.mo</span></code> files.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./.venv/lib/python3.11/site-packages/sphinx_book_theme/assets/translations"
        },
